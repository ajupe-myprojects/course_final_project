<main class="content-main mbott-30">
    <article class="welcome-container clear">
        <div class="content-left t-left black">
            <article class="pd-10">
                <h2 class="t-center orange-text mbott-30">Impressum</h2>
                
                <p class="">Verantwortlich für den Inhalt dieser Webseite: </p><br>
                <p>Andreas Jupe<br>Bernhard Winter Straße 01<br>55120 Mainz<br><a href="mailto:ajupe71@gmx.net">E-mail</a></p><br>
                <p class="">Haftungsausschluß</p><br>
                ...
                <p>5. Legal validity of this disclaimer 
