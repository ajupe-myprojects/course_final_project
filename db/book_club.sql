...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Jan 2020 um 17:13
...
(9, 'Test Kommentar', 'Nur ein Test!', 8, 9, 1, '2020-01-18 20:05:17', '2020-01-18 20:05:17');
...
(8, 'Test Review', 'Testreviews sind schwierig.\r\nLorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.', 9, '2020-01-18 20:04:51', '2020-01-18 20:04:51', 1);
...
(1, 'andymin', 'super@test.de', '$2y$10$88hRuE/LkjwnG6hFS8H0KOKidOBEIopOV.P1110GMiLGsGrcPRzbC', '2020-01-08 10:38:28', '2020-01-17 15:12:07', 23, 'Bow down mortals! For i am the admin!'),
(2, 'Normie', 'test@test.de', '$2y$10$w9U1sdLdt3p6DV5tRNtBEe3568bQseO8b1iMfO6J8k5inwpWthQ2.', '2020-01-13 16:21:20', '2020-01-17 15:05:44', 1, NULL),
...
ALTER TABLE `reviews`
  ...
  ADD KEY `reviews_ibfk_1` (`rev_element_id`);
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `reviews_ibfk_1` FOREIGN KEY (`rev_element_id`) REFERENCES `elements` (`id`) ON DELETE NO ACTION,
